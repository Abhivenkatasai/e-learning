...
async function uploadToS3Bucket(stream, credential, cd) {
    try {
        ...
        let uploadItem = await s3.upload({
            Bucket: credential.Bucket,
            Key: 'abhi-E-learning',// name for the bucket file
...
async function uploadMedia() {
    let credentialRequest = {
        accressKeyId: 'AKIAUGK6NXLE65DNXFOE',
        secretAccessKey: '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',
        signatureVersion: 'v4',
        region: 'us-east-1',
        Bucket: 'abhi-e-learning'
    };
